...
public class EvolutionKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<EvolutionKeyguardSliceProvider> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(EvolutionKeyguardSliceProvider evolutionKeyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
        ...
        public void onPostExecute(Bitmap bitmap) {
            EvolutionKeyguardSliceProvider evolutionKeyguardSliceProvider;
            synchronized (this) {
