...
public class KeyguardSliceProviderEvolution extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderEvolution> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderEvolution keyguardSliceProviderEvolution, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderEvolution);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderEvolution.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderEvolution keyguardSliceProviderEvolution;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderEvolution = (KeyguardSliceProviderEvolution) mProviderReference.get();
            }
            if (keyguardSliceProviderEvolution != null) {
                keyguardSliceProviderEvolution.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderEvolution#onBindSlice");
        Slice slice;
