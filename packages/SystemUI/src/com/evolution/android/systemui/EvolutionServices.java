...
@SysUISingleton
public class EvolutionServices extends VendorServices {
    ...
    @Inject
    public EvolutionServices(Context context, UiEventLogger uiEventLogger, AlarmManager alarmManager, StatusBar statusBar) {
        super(context);
