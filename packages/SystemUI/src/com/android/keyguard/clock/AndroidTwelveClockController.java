 ...
 */
public class AndroidTwelveClockController implements ClockPlugin {

    public static final String TAG = "clockWeight";
    private final float mTextSizeNormal = 48f;
    private final float mSliceTextSize = 19f;
    private final float mTitleTextSize = 19f;
    ...
    public String getName() {
        return "android_twelve_clock";
    }

    @Override
    public String getTitle() {
         return mResources.getString(R.string.clock_title_android_twelve);
    }
    ...
    public Bitmap getThumbnail() {
        return BitmapFactory.decodeResource(mResources, R.drawable.twelveclock_thumbnail);
    }
    ...
    public void setSlice(Slice slice) {
        ...
        if (!mHasHeader) {
            ...
            mTitle.setShadowLayer(3f, 0, 0, Color.BLACK);
        ...
        for (int i = startIndex; i < subItemsCount; i++) {
            ...
            if (button == null) {
                ...
                button.setShadowLayer(3f, 0, 0, Color.BLACK);
    ...
    public void setDarkAmount(float darkAmount) {
        ...
        mClock.setTextSize(89f + (10f * darkAmount));
