...
public class HeadsUpAppearanceController implements OnHeadsUpChangedListener,
    ...
    // Evolution X Logo
    private final ImageView mEvolutionLogo;
    ...
    private void setShown(boolean isShown) {
        ...
        if (mShown != isShown) {
            ...
            if (isShown) {
                ...
                if (mShowLogo) {
                    CrossFadeHelper.fadeOut(mEvolutionLogo, CONTENT_FADE_DURATION/* duration */,
                                0 /* delay */, () -> mEvolutionLogo.setVisibility(View.INVISIBLE));
                }
                ...
                if (mShowLogo) {
                    CrossFadeHelper.fadeIn(mEvolutionLogo, CONTENT_FADE_DURATION /* duration */,
                                CONTENT_FADE_DELAY /* delay */);
                }
                if (mShowCarrierLabel == 2 || mShowCarrierLabel == 3) {
