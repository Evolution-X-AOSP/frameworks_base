...
public class MobileSignalController extends SignalController<
    ...
    private boolean vowifiEnabled() {
        return Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.VOWIFI_ICON, 1, UserHandle.USER_CURRENT) == 1;
    }
    ...
    public void notifyListeners(SignalCallback callback) {
        ...
        int volteIcon = (volteEnabled() && mConfig.showVolteIcon) ? volteResId : 0;
        MobileIconGroup vowifiIconGroup = getVowifiIconGroup();
        boolean vowifiIcon = vowifiEnabled() && mConfig.showVowifiIcon && vowifiIconGroup != null;
        if (mImsManager != null ) {
