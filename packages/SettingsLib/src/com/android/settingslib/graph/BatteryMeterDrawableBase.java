...
public class BatteryMeterDrawableBase extends Drawable {
    ...
    public static final int BATTERY_STYLE_BIG_CIRCLE = 2;
    public static final int BATTERY_STYLE_DOTTED_CIRCLE = 3;
    public static final int BATTERY_STYLE_PA_CIRCLE = 4;
    ...
    public BatteryMeterDrawableBase(Context context, int frameColor) {
        ...
        this(context, frameColor, BATTERY_STYLE_Q);
    }
    ...
    private boolean shouldAnimateCharging() {
        return (mMeterStyle == BATTERY_STYLE_PA_CIRCLE ||
                mMeterStyle == BATTERY_STYLE_DOTTED_CIRCLE ||
                mMeterStyle == BATTERY_STYLE_BIG_CIRCLE ||
                mMeterStyle == BATTERY_STYLE_CIRCLE) && mAnimateCharging;
    }
    ...
    private void updateSize() {
        ...
        mIntrinsicWidth = mMeterStyle == BATTERY_STYLE_Q ?
    ...
    private void drawDottedCircle(Canvas c) {
        final int level = mLevel;
        final Rect bounds = getBounds();
    ...
    protected float getAspectRatio() {
        if (mMeterStyle != BATTERY_STYLE_Q) {
