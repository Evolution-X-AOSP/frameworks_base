...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.BOTTOM_GESTURE_TRIGGER_TIMEOUT), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
    ...
    private void updateKeyAssignments() {
        ...
        mAssistPressActionHwKeys = Action.fromIntSafe(res.getInteger(
        ...
        mAppSwitchPressActionHwKeys = Action.fromIntSafe(res.getInteger(
    ...
    public void sendCustomAction(Intent intent) {
        ...
        if (action != null) {
            if (ActionHandler.INTENT_SHOW_POWER_MENU.equals(action)) {
                ...
                mScreenshotRunnable.setScreenshotType(TAKE_SCREENSHOT_SELECTED_REGION);
                mHandler.post(mScreenshotRunnable);
            } else if (EvolutionUtils.INTENT_SCREENSHOT.equals(action)) {
